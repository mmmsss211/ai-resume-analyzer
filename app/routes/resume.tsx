...
const Resume = () => {
  ...
  return (
    <main className="pb-20">
      ...
      <section className="p-4 relative flex flex-col-reverse lg:grid lg:grid-cols-[2fr_3fr] gap-8 w-full max-w-6xl mx-auto z-50">
            ...
            {imageUrl && resumeUrl && (
              <a href={resumeUrl} target="_blank" rel="noopener noreferrer">
                <img
                  src={imageUrl}
                  alt="Resume preview"
                  className="w-full h-auto object-contain rounded-md shadow-lg border border-gray-200 hover:shadow-xl transition-shadow"
                />
              </a>
            )}
          </div>
